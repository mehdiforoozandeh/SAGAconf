...
paramdict_1 = {"name_sig_main":"concat_11", "name_sig_aux":"concat_12",
    "random_seed":73, "include":'encodePilotRegions.hg19.bed', "track_weight":float(1e-2/12),
...
paramdict_2 = {"name_sig_main":"concat_21", "name_sig_aux":"concat_22",
    "random_seed":73, "include":'encodePilotRegions.hg19.bed', "track_weight":float(1e-2/12),
    "stws":1e-2, "ruler_scale":1000, "prior_strength":1, "resolution":1000,
...
parse_posterior_results("batch_runs/posterior_concat_11", 'batch_runs/encodePilotRegions.hg19.bed', 1000, M=50)
parse_posterior_results("batch_runs/posterior_concat_12", 'batch_runs/encodePilotRegions.hg19.bed', 1000, M=50)
parse_posterior_results("batch_runs/posterior_concat_21", 'batch_runs/encodePilotRegions.hg19.bed', 1000, M=50)
parse_posterior_results("batch_runs/posterior_concat_22", 'batch_runs/encodePilotRegions.hg19.bed', 1000, M=50)